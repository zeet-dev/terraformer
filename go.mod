...
require (
	github.com/GoogleCloudPlatform/terraformer/terraformutils v0.0.0-00010101000000-000000000000
...
replace github.com/GoogleCloudPlatform/terraformer/terraformutils => ./terraformutils
